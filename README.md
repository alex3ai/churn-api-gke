...
![FastAPI](https://img.shields.io/badge/FastAPI-0.95%2B-009485.svg)
![Docker](https://img.shields.io/badge/Docker-blue.svg)
![Scikit-learn](https://img.shields.io/badge/SciKit--Learn-orange.svg)
![LightGBM](https://img.shields.io/badge/LightGBM-purple.svg)
...
## 📋 Tabela de Conteúdos
1. [O Problema de Negócio](#-o-problema-de-negócio)
2. [Análise e Insights dos Dados](#-análise-e-insights-dos-dados-eda)
3. [Metodologia de Machine Learning](#-metodologia-de-machine-learning)
4. [Tecnologias Utilizadas](#-tecnologias-utilizadas)
5. [Estrutura do Projeto](#-estrutura-do-projeto)
6. [Como Executar a API Localmente](#-como-executar-a-api-localmente)
...
```bash
git clone https://github.com/alex3ai/churn-prediction-api.git
cd churn-prediction-api
```

**2. Construa a imagem Docker:** Este comando lê o `Dockerfile` e monta a imagem da nossa aplicação com todas as dependências.

```Bash
docker build -t churn-api .
```

**3. Execute o container:** Este comando inicia um container a partir da imagem, mapeando a porta 8000 da sua máquina para a porta 8000 do container.
